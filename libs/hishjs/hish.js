+function ($) { "use strict";
  ...
  Hish.prototype.bindEvents = function() {
    ...
    $('#hish-share-linkedin').click(function(e) {
      var facebook_dialog_url = "http://www.linkedin.com/shareArticle?mini=true&url=" + document.URL + "&title=" + _this.getText() + "&summary=" + _this.getText();
      var facebook_popup = window.open(facebook_dialog_url,'facebook-share','height=600,width=500');
      if (window.focus) {facebook_popup.focus()}
      _this.hide();
    ...
    $('#hish-share-linkedin').mousedown(function(e){
      e.preventDefault();
    })
  }
    ...
    if (!document.getElementById('hish-share-wrapper')) {
      $("<div id='hish-share-wrapper'>" +
          "<div id='hish-share-popover-inner'>" + 
            ...
            "<div id='hish-share-linkedin'><i class='icon-linkedin icon-light-hish' style='color:#fff;line-height:22px;width:22px;height:22px;padding-top:30px;padding-left:5px'></i></div>" + 
          "</div>" +
